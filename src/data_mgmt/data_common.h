...
#define TOKEN_SO_PIN_PROMPT		_("Enter the TCM security officer password: ")
#define TOKEN_SO_NEW_PIN_PROMPT		_("A new TCM security officer password is needed. " \
					"The password must be between %d and %d characters " \
					"in length.\n" \
					"Enter new password: ")

#define TOKEN_USER_INIT_PIN		"12345678"
#define TOKEN_USER_PIN_PROMPT		_("Enter your TCM user password: ")
#define TOKEN_USER_NEW_PIN_PROMPT	_("A new TCM user password is needed. " \
					"The password must be between %d and %d characters " \
					"in length.\n" \
					"Enter new password: ")
...
#define TOKEN_NOT_INIT_ERROR		_("Error, the TCM token has not been initialized\n")
