...
static void pcrInfoShortDisplay(TCM_PCR_INFO_SHORT *tpis, const char *type)
{
	UINT16 i, c;
...
static void nvindexDisplay(TSM_HTCM hTpm, UINT32 nvindex)
{
	TSM_RESULT res;
	char *buffer;
...
int main(int argc, char **argv)
{
	...
	if (getCapability(hTpm, TSM_TCMCAP_NV_LIST, 0, NULL,
			  &ulResultLen, &pResult) != TSM_SUCCESS) {
		goto out_close;
	}
