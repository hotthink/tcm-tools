...
static TSM_RESULT
tpmRevokeEk(TSM_HTCM a_hTpm, UINT32 revDataSz, BYTE *revData)
{
	TSM_RESULT result = Tspi_TCM_RevokeEndorsementKey( a_hTpm, revDataSz, revData);
	tspiResult("Tspi_TCM_RevokeEndorsementKey", result);
	return result;
}
